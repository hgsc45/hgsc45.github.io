...
/** @type {string} */
const CACHE_VERSION = '1740796144|1960541594';
/** @type {string} */
const CACHE_PREFIX = 'PedroTheRaccoon-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'PedroTheRaccoon.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["PedroTheRaccoon.html","PedroTheRaccoon.js","PedroTheRaccoon.offline.html","PedroTheRaccoon.icon.png","PedroTheRaccoon.apple-touch-icon.png","PedroTheRaccoon.worker.js","PedroTheRaccoon.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["PedroTheRaccoon.wasm","PedroTheRaccoon.pck"];
