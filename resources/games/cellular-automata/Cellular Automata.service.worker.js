...
/** @type {string} */
const CACHE_VERSION = '1737854116|1671543782';
/** @type {string} */
const CACHE_PREFIX = 'Cellular Automat-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Cellular Automata.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Cellular Automata.html","Cellular Automata.js","Cellular Automata.offline.html","Cellular Automata.icon.png","Cellular Automata.apple-touch-icon.png","Cellular Automata.worker.js","Cellular Automata.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Cellular Automata.wasm","Cellular Automata.pck"];
